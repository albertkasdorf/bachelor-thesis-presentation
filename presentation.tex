...
\begin{frame}
	...
	\begin{itemize}
		\item UWB Module
			\begin{itemize}
				\item Erstellung der UWB Module möglich.
				\item Entfernungsmessung möglich, aber ohne Optimierungen.
			\end{itemize}
		\item RO-SLAM
			\begin{itemize}
				\item Ergebnisse abhängig von der Qualität der Entfernungsmessung.
				\item Wenig Einstellungsmöglichkeiten.
			\end{itemize}
	\end{itemize}
\end{frame}
